...
import { getAiTools, runAiTool } from "@/lib/ai/tools";
...
- If a websearch tool is available, use it for up-to-date facts the archive can't answer, and cite sources by their url. If it is not available, say plainly that you have no live internet access.
